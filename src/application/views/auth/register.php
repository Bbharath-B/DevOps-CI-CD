				...
				<div class="col-md-4">
					...
					<div class="form-group required row">
						...
						<div class="col-md-8">
							...
							<input class="form-control" type="tel" required name="phone" placeholder="5554459290" minlength="10" value="<?php if($this->input->post('phone') != null) echo $this->input->post('phone') ?>" />
						</div>
					</div>
