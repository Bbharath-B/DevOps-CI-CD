    ...
    <section>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="footer-block col-md-2 col-sm-2">
                </div>

                <div class="footer-block col-md-3 col-sm-3 cf">
                    <img class="footer-logo" src="<?= base_url('resources/images/logo.png') ?>" alt="ICD logo">
                    <div class="mb-3"><small>International Courier Software</small></div>
                </div>
                ...
                <div class="footer-block col-md-3 col-sm-3">
                    ...
                    <ul class="hidden-xs basic no-padding">
                        ...
                        <li><a href="<?= site_url('tracking') ?>" tabindex="-1">Track A Parcel</a></li>
                    </ul>
                </div>
        ...
        <section class="footer-baseline">
            <div class="container">
                <ul class="footer-links list-inline">
                    ...
                    <li><a href="<?= site_url('legal/terms') ?>" tabindex="-1">Terms And Conditions</a></li>
                    <li><a href="<?= site_url('legal/refund_policy') ?>" tabindex="-1">Refund Policy</a></li>
                </ul>
