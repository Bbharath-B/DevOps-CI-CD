<div class="page-content">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-9 margin-0-auto col-sm-12">
                ...
                <form action="<?= site_url('admin/add_package') ?>" method="POST">
                    ...
                    <div class="form-group">
                        <input type="checkbox" name="notify_user_email" value="true" checked> &nbsp;&nbsp;
                        <label for="notify_user_email">Notify the user via email</label>
                    </div>

                    <div class="form-group">
                        <input type="checkbox" name="notify_user_sms" value="true"> &nbsp;&nbsp;
                        <label for="notify_user_sms">Notify the user via SMS</label>
                    </div>
