...
class User_model extends CI_Model
{
	...
	public function update_account($title, $fname, $lname, $email, $phone, $company, $address, $country, $state, $city, $zip, $user_id){
		...
		$this->db->where('id', $user_id)->update('user', $user);
		...
		$this->db->where('user_id', $user_id)->update('address', $address);
	...
	public function get_user_by_id($user_id) {
		...
		return $this->db->where('id', $user_id)->get('user')->result_array();
