            ...
            <tbody>
                <?php foreach($staff as $s) { ?>
                    <tr>
                        ...
                        <td><?= $s['phone'] ?></td>
                        <td><?= $s['registered'] ?></td>
                        <td><a href="<?= site_url('admin/user/' . $s['id']) ?>" class="btn btn-block btn-default btn-sm"><i class="fas fa-wrench"></i></a></td>
                    </tr>
                <?php } ?>
            </tbody>
        </table>
            ...
            <tbody>
                <?php foreach($users as $u) { ?>
                    <tr>
                        ...
                        <td><?= $u['phone'] ?></td>
                        <td><?= $u['registered'] ?></td>
                        <td><a href="<?= site_url('admin/user/' . $u['id']) ?>" class="btn btn-block btn-default btn-sm"><i class="fas fa-wrench"></i></a></td>
                    </tr>
                <?php } ?>
            </tbody>
        </table>
